...
# Task 3 - change the vlaues of the diff. Impacts so they are all between 0 and 1 #####


?scale

normal_GHG_wheat <-scale(mapGHG_stack)
plot(normal_GHG_wheat)




# Task 4a - Hotspot analysis - top 10% of grids####
...
#for WD different approach:
#show every raster above 1 
